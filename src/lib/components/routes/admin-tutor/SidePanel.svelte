...
{#if open}
  ...
  <aside
    ...
    class="2xs:min-w-[16rem] 2xs:max-w-xs max-2xs:left-2 2xs:w-full fixed top-16 right-0 bottom-2 z-20 flex min-h-[calc(100svh-4.5rem)] shrink-0 grow flex-col overflow-y-auto rounded-l-md border-gray-200 bg-white max-xl:drop-shadow-xl md:top-18 md:min-h-[calc(100svh-5rem)] xl:sticky xl:top-2 xl:left-0 xl:min-h-[calc(100svh-1rem)] xl:rounded-md xl:border xl:drop-shadow-xs"
  >
