...
<div class="flex max-w-fit flex-row items-center rounded-md px-2">
  <Checkbox.Root
    ...
    class="peer inline-flex min-h-6 min-w-6 items-center justify-center rounded-md border-1 border-transparent bg-blue-950 text-white transition-all duration-100 ease-in-out not-disabled:focus-visible:outline-2 not-disabled:focus-visible:outline-offset-2 not-disabled:focus-visible:outline-blue-950/50 active:scale-[0.98] disabled:cursor-not-allowed disabled:border-gray-200 disabled:bg-white not-disabled:data-[state=unchecked]:border-blue-950/50 not-disabled:data-[state=unchecked]:bg-white not-disabled:data-[state=unchecked]:hover:border-blue-900 not-disabled:data-[state=unchecked]:active:border-blue-950"
    bind:checked
    bind:ref
    {...restProps}
  >
