...
<Calendar.Root
  class="max-w-fit overflow-auto rounded-xl border border-gray-200 bg-white p-4 drop-shadow-xs"
  weekdayFormat="short"
  fixedWeeks={true}
  type="single"
  {...restProps}
    ...
    <Calendar.Header class="flex items-center justify-between gap-2">
      {#if variant === 'withPicker'}
        <select
          ...
          class="font-poppins inline-flex w-full min-w-fit items-center justify-center rounded-md border-0 bg-white text-base font-medium text-gray-800 transition-all duration-100 open:bg-blue-100 hover:bg-blue-50 hover:text-blue-950 open:hover:bg-blue-100 focus-visible:ring-0 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-950/50 active:scale-[0.98] active:bg-blue-100 active:text-blue-950"
          onchange={(e) => {
        ...
        <select
          ...
          class="font-poppins inline-flex max-w-fit min-w-fit items-center justify-center rounded-md border-0 bg-white text-base font-medium text-gray-800 transition-all duration-100 open:bg-blue-100 hover:bg-blue-50 hover:text-blue-950 open:hover:bg-blue-100 focus-visible:ring-0 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-950/50 active:scale-[0.98] active:bg-blue-100 active:text-blue-950"
          onchange={(e) => {
