...
<Dialog.Root bind:open {...restProps}>
  ...
  <Dialog.Portal>
    ...
    <Dialog.Content
      class="fixed bottom-0 z-100 flex h-auto max-h-3/4 min-h-1/2 w-[calc(100%-1rem)] max-w-lg flex-col justify-between self-center overflow-hidden rounded-t-lg bg-white outline-hidden drop-shadow-md"
      forceMount
      {...contentProps}
    >
